...
######################## METODOLOGIA #########################
##WORD
#### JUSTIFICACION DE LOS DATOS PARA CUMPLIMIENTO DE LOS DATOS
...
##DATA#### CANTIDAD DE INCIDENCIAS POR DIA Y CLIENTES CORTE POR ROBO DE FIBRA Y DESCONOCIDO Y MODIFICAR CAUSAS A ESTAS DOS
##WORD#### GRAFICAS DE ESCALARES
##WORD#### JUSTIFICACION DE LOS LAS EPOCAS SIN MODELO Y GRAFICAR X N EPOCAS
##WORD#### JUSTIFICACION DEL MAE Y R2 AGREGAR MSE
##WORD#### COMPARACION DE LOS MODELOS
